...
function getProduct(displayLabels) {
    ...
    document.getElementById('add-to-order').onclick = function() {
        ...
        for (let i = 0; i < displayLabels.length; i++) {
            ...
            // if the quantity entered were wrong: smaller than 0 or bigger than (2 or 250), disregard action
